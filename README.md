...
Aether 是一款专为开发者设计的现代 SSH 终端连接工具。它突破了传统 SSH 客户端单调刻板的视觉局限，采用令人惊艳的现代化 UI，拥有顺滑细腻的微交互动画，并集成了多项深度本地化、自动云端同步等高阶功能，致力于提供非凡的终端连接和设备管理体验。
 (本项目的UI界面以及灵感参考Netcatty以及xterminal)
